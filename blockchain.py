...
class Blockchain(object):
    ...
    def resolve_conflicts(self):
        ...
        # We are only looking for chains that are longer than ours
...
def mine():
    ...
    # We must recieve a reward for finding proof.
    # The sender is 0 to signify this node has mined the coin
